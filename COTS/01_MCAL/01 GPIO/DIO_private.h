...
#define 	GPIOA_set_pin		GPIOA_BSRR= (1<<pin)
#define 	GPIOA_clr_pin 		GPIOA_BRR = (1<<pin)

#define 	GPIOB_set_pin		GPIOB_BSRR= (1<<pin)
#define 	GPIOB_clr_pin 		GPIOB_BRR = (1<<pin)

#define 	GPIOC_set_pin		GPIOC_BSRR= (1<<pin)
#define 	GPIOC_clr_pin 		GPIOC_BRR = (1<<pin)
